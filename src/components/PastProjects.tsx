export default function PastProjects() {
  ...
  return (
    <section id="past-projects" className="py-20 bg-gray-50 scroll-mt-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-16">
          <div id="education-projects" className="scroll-mt-28">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">Education</h3>
            <p className="text-gray-600 mb-8">
              Before co-founding Embr Labs, I was very interested in the future
              of education and technology-enabled learning. My interest started
              when I was a teaching assistant for the thermodynamics materials
              science undergraduate course for two years. I was further
              influenced by the launch of Massive Open Online Courses (MOOCs)
              and the founding of platforms like EdX, Udacity, and Coursera
              while I was at MIT. Some of my work reflects that interest:
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {educationProjects.map((project, index) => (
                ...
                >
                  ...
                  <p
                    className="text-gray-700 text-sm leading-relaxed [&_a]:text-blue-600 [&_a]:hover:text-blue-800 [&_a]:underline [&_a]:bg-transparent [&_a]:px-0 [&_a]:py-0 [&_a]:rounded-none"
          ...
          <div id="materials-projects" className="scroll-mt-28">
            ...
            <p className="text-gray-600 mb-8">
              During my time at MIT, I was an active undergraduate researcher
              working primarily with Professor Jeffrey Grossman and Professor W.
              Craig Carter. While I didn&apos;t end up pursuing graduate work in
              materials science, I&apos;m proud of the work I did as an
              undergraduate.
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div id="wrestling-projects" className="scroll-mt-28">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">Wrestling</h3>
            <p className="text-gray-600 mb-8">
              More than almost anything else, wrestling has made me the person I
              am today. The sport helped me evolve from an insecure 88lbs
              freshman in high school to the first New England Champion in my
              school&apos;s history and then a National Champion at MIT. As Dan
              Gable said, &quot;Once you&apos;ve wrestled, everything else in
              life is easier.&quot;
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {creativeWriting.map((piece, index) => (
                ...
                >
                  ...
                  <p
                    className="text-gray-600 text-sm [&_a]:text-blue-600 [&_a]:hover:text-blue-800 [&_a]:underline [&_a]:bg-transparent [&_a]:px-0 [&_a]:py-0 [&_a]:rounded-none"
